...
class Dataset:
    ...
    def convert_arrays(self):
        ...
        input_images = np.array(self.input_images[0:4096])
        #self.input_images = np.array(self.input_images)
        partial_sequences = np.array(self.partial_sequences[0:4096])
        next_words = np.array(self.next_words[0:4096])
        print("done")
    ...
    def save_metadata(self, path):
        print("self.input_shape, self.output_size, self.size",self.input_shape, self.output_size, self.size)
        self.size= 100
